...
>
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        >
          <p>
            {`Hi! I'm <strong>Umer Adnan</strong>, a frontend web developer from
            Pakistan. I specialize in building fast, accessible, and scalable
            web applications using modern frameworks like <strong>Next.js</strong>,{" "}
